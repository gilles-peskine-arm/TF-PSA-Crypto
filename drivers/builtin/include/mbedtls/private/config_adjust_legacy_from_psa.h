...
#define MBEDTLS_PSA_BUILTIN_ALG_ASCON_HASH256 1
#endif
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_ASCON_AEAD128)
#if defined(PSA_WANT_KEY_TYPE_ASCON)
#define MBEDTLS_PSA_BUILTIN_ALG_ASCON_AEAD128 1
#endif /* PSA_WANT_KEY_TYPE_ASCON */
#endif /* !MBEDTLS_PSA_ACCEL_ALG_ASCON_AEAD128 */
