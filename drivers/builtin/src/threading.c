...
static inline void mbedtls_platform_mutex_init(mbedtls_platform_mutex_t *mutex)
{
    (void) pthread_mutex_init(mutex, NULL);
}

static inline void mbedtls_platform_mutex_free(mbedtls_platform_mutex_t *mutex)
{
    (void) pthread_mutex_destroy(mutex);
}

static int mbedtls_platform_mutex_lock(mbedtls_platform_mutex_t *mutex)
{
...
static int mbedtls_platform_mutex_unlock(mbedtls_platform_mutex_t *mutex)
{
