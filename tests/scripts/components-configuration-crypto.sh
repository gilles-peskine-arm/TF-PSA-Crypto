...
component_build_aes_aesce_armcc () {
    ...
    helper_armc6_cmake_build_test "-O1 --target=aarch64-arm-none-eabi -march=armv8-a+crypto"
...
component_test_block_cipher_no_decrypt_aesce_armcc () {
    ...
    helper_armc6_cmake_build_test "-O1 --target=aarch64-arm-none-eabi -march=armv8-a+crypto -Werror -Wall -Wextra"
