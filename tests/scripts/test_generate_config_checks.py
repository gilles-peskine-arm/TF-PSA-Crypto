...
class CryptoTestConfigChecks(test_config_checks_generator.TestConfigChecks):
    """TF-PSA-Crypto unit tests for checks generated by config_checks_generator."""
    ...
    def test_crypto_exempt_define_MBEDTLS_USE_PSA_CRYPTO(self) -> None:
        self.good_case('#define MBEDTLS_USE_PSA_CRYPTO',
                       extra_options=['-DTF_PSA_CRYPTO_CONFIG_CHECK_ALLOW_REMOVED_OPTIONS'])
    ...
    def test_up_to_date(self) -> None:
        self.up_to_date_case(generate_config_checks.CRYPTO_REMOVED_OPTIONS)
