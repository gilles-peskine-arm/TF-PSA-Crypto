...
component_test_entropy_nv_seed_only () {
    ...
    not grep getrandom library/entropy*.o library/platform*.o
    not grep /dev/random library/entropy*.o library/platform*.o
    not grep /dev/.random library/entropy*.o library/platform*.o
    not grep mbedtls_platform_get_entropy library/entropy*.o library/platform*.o
}
