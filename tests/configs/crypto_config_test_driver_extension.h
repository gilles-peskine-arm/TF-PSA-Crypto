...
#undef MBEDTLS_PSA_ACCEL_ALG_SHAKE256_512
#else
#define MBEDTLS_PSA_ACCEL_ALG_SHAKE256_512 1
#endif
#endif

#if defined(PSA_WANT_ALG_SHAKE128_256)
#if defined(MBEDTLS_PSA_ACCEL_ALG_SHAKE128_256)
#undef MBEDTLS_PSA_ACCEL_ALG_SHAKE128_256
#else
#define MBEDTLS_PSA_ACCEL_ALG_SHAKE128_256 1
#endif
#endif
